...
public class DlgInfoErrHistPnt
  extends DlgAbstract
{
  ...
  JScrollTable mTable = new JScrollTable(EnumTableID.DLG_MONITOR_INFO_ERR_PNT);
  
  public DlgInfoErrHistPnt(ArrayList paramArrayList)
  {
    try
    {
      jbInit();
  ...
  private void initTable()
  {
    ...
    arrayOfString[1] = StrRes.getStr("IDS_COMMON_ERR_CODE");
    arrayOfString[2] = StrRes.getStr("IDS_COMMON_ERR_UNIT_NO");
    ...
    localTableColumnModel.getColumn(1).setPreferredWidth(70);
    ...
    mTable.getScrollPane().setPreferredSize(new Dimension(295, 250));
  }
    ...
    throws Exception
  {
    ...
    mBtnClose.addActionListener(new DlgInfoErrHistPnt_mBtnClose_actionAdapter(this));
  ...
  private void partsInit(ArrayList paramArrayList)
  {
    ...
    for (int j = 0; j < paramArrayList.size(); j++)
    {
      ...
      if (!localTargetErr.isNormal())
      {
        ...
        arrayOfString[1] = localTargetErr.getErrCodeStr();
        arrayOfString[2] = localTargetErr.getUnitNoStr();

  ...
  extends PanelAbstract
{
    ...
    throws Exception
  {
    ...
    add(mOk, new GridBagConstraints(0, 0, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(10, 10, 10, 10), 0, 0));
    add(mCancel, new GridBagConstraints(1, 0, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(10, 10, 10, 10), 0, 0));
  }
